...
# Marathon app data and expected BIG-IP configs
marathon_test_data = {
    'tests/marathon_one_app_in_subdir.json':
    'tests/marathon_one_app_in_subdir_expected.json',
    'tests/marathon_invalid_apps.json':
    'tests/marathon_invalid_appsi_expected.json',
    'tests/marathon_two_apps.json':
    'tests/marathon_two_apps_expected.json',
    'tests/marathon_app_no_hm.json':
    'tests/marathon_app_no_hm_expected.json',
    'tests/marathon_one_app_missing_data.json':
    'tests/marathon_one_app_missing_data_expected.json',
    'tests/marathon_one_app_no_port_label.json':
    'tests/marathon_one_app_no_port_label_expected.json',
    'tests/marathon_one_app_two_service_ports.json':
    'tests/marathon_one_app_two_service_ports_expected.json',
    'tests/marathon_app_with_one_unconfig_service_port.json':
    'tests/marathon_app_with_one_unconfig_service_port_expected.json',
    'tests/marathon_no_apps.json':
    'tests/marathon_no_apps_expected.json',
    'tests/marathon_one_app_zero_instances.json':
    'tests/marathon_one_app_zero_instances_expected.json',
    'tests/marathon_one_app_https.json':
    'tests/marathon_one_app_https_expected.json',
    'tests/marathon_one_app_two_health_checks.json':
    'tests/marathon_one_app_two_health_checks_expected.json',
    'tests/marathon_one_app_pool_only.json':
    'tests/marathon_one_app_pool_only_expected.json'
}
...
class MarathonTest(unittest.TestCase):
    ...
    def test_marathon_configs(self):
        ...
        for key, value in marathon_test_data.items():
            self.verify_marathon_config(key, value)

    def start_two_apps_with_two_partitions(
            self, partitions, expected_name1, expected_name1_count,
            expected_name2, expected_name2_count,
        ...
        for partition in partitions:
            with patch.object(ManagementRoot, '_get_tmos_version'):
                ...
                if len(cfg['virtualServers']) > 0:
                    if expected_name1 == cfg['virtualServers'][0]['name']:
                        name1_count += 1
                    if expected_name2 == cfg['virtualServers'][0]['name']:
                        name2_count += 1

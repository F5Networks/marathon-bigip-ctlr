...
This guide describes how to set up a reference F5® |csc| in a Mesos environment with Marathon. This guide is intended to help users understand the components and services F5 provides for use in containerized environments.
...
.. seealso::
    ...
    If you would like to use the F5 |csc_m| in an existing Mesos environment, please see the :ref:`User Guide <cscm-user-guide>`.
